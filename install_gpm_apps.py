...
from android_scripts_python.library.configure_machine import myGPMDir
...
def main():
    ...
    if is_adb_device(main_functions.deviceSerial):
        ...
        install_machine_files(main_functions.deviceSerial, myGPMDir, sub_folder, search_string)
    else:
